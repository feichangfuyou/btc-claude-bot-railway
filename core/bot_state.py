...
class BotState:
    ...
    def snapshot(self) -> dict:
        ...
        return {
            ...
            "analysis_decision": self.claude_decision,
            "bot_running": self.bot_running,
            "claude_thinking": self.claude_thinking,
            "analysis_thinking": self.claude_thinking,
            "last_claude_call": self.last_claude_call,
            "last_analysis_call": self.last_claude_call,
            "countdown": self.countdown,
            "has_claude_key": bool(ANTHROPIC_API_KEY),
            "has_engine_key": bool(ANTHROPIC_API_KEY),
