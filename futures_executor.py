...
from database import db_save_state, db_save_trade
from notifications import send_notification
from trade_memory import record_trade_memory, run_learning_cycle
...
def close_futures_position(bot, pos: dict, exit_price: float, reason: str):
    ...
    if FUTURES_LIVE and product_id and coin_size > 0:
        try:
            ...
            from coinbase_api import close_perpetual_position
...
async def execute_futures_live(
    ...
    try:
        from coinbase_api import create_perpetual_order
