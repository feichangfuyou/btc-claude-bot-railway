...
export function AnalyticsSection({ connected, log, lossToast, cbLive, krakenEnabled, hasClaude, isLiveMode, agentKit, paperMode, directionBias, requireTradeApproval, price, priceAge, wsRetrying }) {
